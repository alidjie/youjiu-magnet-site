...
async function getProduct(slug: string): Promise<Product | null | undefined > {
  try {
...
export async function generateMetadata({ params }: DetailPageProps) {
  ...
  if (!product) return { title: 'Product Not Found | YOUJIU' }
  return {
    title: `${product.name} | NdFeB Magnet | YOUJIU`,
