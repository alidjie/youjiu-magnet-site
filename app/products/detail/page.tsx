...
function getProduct(slug: string | null): Product | null {
  if (!slug) return null
    ...
    return (
      <section className="section-padding bg-white">
        <div className="container-custom text-center">
          ...
          <Link href="/products" className="mt-6 inline-block bg-neutral-900 px-6 py-3 text-sm text-white">
            Back to Products
          </Link>
        </div>
      </section>
    ...
    <>
      <section className="section-padding bg-neutral-50">
        <div className="container-custom">
          ...
          <SectionTitle title={product.name} subtitle={product.description} />
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            <div className="relative aspect-square overflow-hidden border border-neutral-200 bg-neutral-100">
              <Image src={imageSrc} alt={product.name} fill className="object-cover" sizes="50vw" priority />
            </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <h2 className="mt-6 text-2xl font-bold tracking-tight text-foreground sm:text-3xl">{product.name}</h2>
