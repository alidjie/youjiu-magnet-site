...
export const metadata = {
  title: 'Product Details | NdFeB Magnet | YOUJIU',
  description: 'View detailed specifications and request a quote for YOUJIU NdFeB magnets.',
}
...
export default async function ProductDetailPage({ searchParams }: DetailPageProps) {
    ...
    return (
      <section className="section-padding bg-white">
        <div className="container-custom text-center">
          ...
          <p className="mt-4 text-neutral-500">Please select a product from the list.</p>
          <Link href="/products" className="mt-6 inline-block bg-neutral-900 px-6 py-3 text-sm text-white">Back to Products</Link>
        </div>
      </section>
    )
  }
  ...
  if (!product) {
    return (
      <section className="section-padding bg-white">
        <div className="container-custom text-center">
          <h1 className="text-2xl font-bold">Product Not Found</h1>
          <p className="mt-4 text-neutral-500">The requested product could not be found.</p>
          <Link href="/products" className="mt-6 inline-block bg-neutral-900 px-6 py-3 text-sm text-white">Back to Products</Link>
        </div>
      </section>
    )
